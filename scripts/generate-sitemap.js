...
// Tourism categories
const tourismData = JSON.parse(
  readFileSync(join(ROOT, 'content/tourism/establishments.json'), 'utf8')
);
for (const cat of tourismData.categories) {
  urls.push(url(`/tourism/${cat.id}`, '0.8', 'weekly'));
}
